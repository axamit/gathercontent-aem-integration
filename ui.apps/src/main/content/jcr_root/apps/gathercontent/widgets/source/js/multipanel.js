...
GC.CQ.MultiFieldPanel = CQ.Ext.extend(CQ.Ext.Panel, {
    panelValue: '',
    ...
    constructor: function(config){
        ...
        GC.CQ.MultiFieldPanel.superclass.constructor.call(this, config);
    },

    initComponent: function() {
        GC.CQ.MultiFieldPanel.superclass.initComponent.call(this);

        var multifield = this.findParentByType('multifield'),
            dialog = this.findParentByType('dialog');

        if(GC.CQ.MultiFieldPanel.xtype === this.xtype){
    ...
    afterRender : function(){
        GC.CQ.MultiFieldPanel.superclass.afterRender.call(this);
...
CQ.Ext.reg("gcmultifieldpanel", GC.CQ.MultiFieldPanel);